...
class Trainer(TrainerBase):
    ...
    def train(self):
        if self.verbose:
            ...
            if "t5" in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLT5_YC2C"
                else:
                    project_name = "T5_YC2C"
            elif "bart" in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLBart_YC2C"
                else:
                    project_name = "Bart_YC2C"
        ...
        for epoch in range(self.args.epochs):
            ...
            if self.verbose:
                valid_score = score_dict["CIDEr"] * 100.0
        ...
        if self.args.submit:
            ...
            if self.verbose:
                ...
                wandb_log_dict["Test/overall"] = score_dict["CIDEr"]
...
def main_worker(gpu, args):
    ...
    from video.yc2c_data import get_loader
