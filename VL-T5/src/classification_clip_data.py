...
class ImageNetFineTuneDataset(Dataset):
    def __init__(
        ...
        self.label_dict = get_class_name(imagenet_dir.joinpath("words.txt"))
    ...
    def __getitem__(self, idx):
        ...
        ###### Image ######
        # on some Linux File System, this should be set to False
        with h5py.File(datum, "r", locking=False) as f:
        ...
        input_ids = self.tokenizer.encode(
            f"{self.args.prompt}", max_length=20, truncation=True
        )
