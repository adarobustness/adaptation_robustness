...
class Trainer(TrainerBase):
    ...
    def train(self):
        if self.verbose:
            ...
            if "t5" in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLT5_How2QA"
                else:
                    project_name = "T5_How2QA"
            elif "bart" in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLBart_How2QA"
                else:
                    project_name = "Bart_How2QA"
        ...
        if self.args.submit:
            ...
            predictions = self.predict(self.submit_test_loader, dump_path)
...
def main_worker(gpu, args):
    ...
    from video.how2qa_data import get_loader
    ...
    if args.submit:
        ...
        submit_test_loader = get_loader(
            args,
            split="test_release,test_public",
            mode="val",
            batch_size=valid_batch_size,
            distributed=args.distributed,
            gpu=args.gpu,
