...
def parse_args(parse=True, **optional_kwargs):
    ...
    parser.add_argument("--subset_ratio", type=float, default=1.0, help="subset ratio used for subset-adaptation corruptions")

    # corruption related
    parser.add_argument("--img_corruption_method",
                        type=str, default="none", help="corruption method", choices=IMG_CORRUPTION_METHODS)
    parser.add_argument("--img_corruption_severity", type=int, default=1, help="corruption severity")
    parser.add_argument("--text_corruption_method",
                        type=str, default="none", help="corruption method", choices=TEXT_CORRUPTION_METHODS)
    parser.add_argument("--text_corruption_severity", type=int, default=1, help="corruption severity")

    # Train or Evaluate or Test
    parser.add_argument("--to_train", type=str2bool, default=True, help="train or not")
    parser.add_argument("--to_eval", type=str2bool, default=True, help="eval or not")
    parser.add_argument("--to_test", type=str2bool, default=False, help="test or not")
    ...
    # this setting should be aligned with the setting in class EncoderPromptConfig
    parser.add_argument("--encoder_prompt_position", type=str, default="front", choices=["front", "back", "middle"])
    parser.add_argument("--encoder_prompt_init_method", type=str, default="normal", choices=["normal", "uniform", "xavier_normal", "kaiming_normal"])
    ...
    parser.add_argument(
        "--feature_type", type=str, default="butd", choices=feature_types
    )
