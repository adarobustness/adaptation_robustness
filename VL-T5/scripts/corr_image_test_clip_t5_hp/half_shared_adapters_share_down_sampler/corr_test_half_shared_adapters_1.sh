...
#  &> test_on_corrupted_images_half_shared_adapters_share_down_sampler_none_1_t5.out
...
bash original_scripts/image_clip_t5_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+8)) \
  --img_corruption_method ${METHOD} \
  --img_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_images_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}_t5.out
...
METHOD=snow
bash original_scripts/image_clip_t5_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+9)) \
  --img_corruption_method ${METHOD} \
  --img_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_images_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}_t5.out
...
METHOD=frost
bash original_scripts/image_clip_t5_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+10)) \
  --img_corruption_method ${METHOD} \
  --img_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_images_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}_t5.out
