...
#  &> test_on_corrupted_text_full_finetuning_none_1_t5.out

# try out
#bash original_scripts/image_clip_t5_corr_test/full_finetuning.sh 26787 \
...
##
##METHOD=swap_prefix
##bash original_scripts/image_clip_t5_corr_test/full_finetuning.sh $((PORT+2)) \
##  --text_corruption_method ${METHOD} \
##  --text_corruption_severity ${SEVERITY} \
##  --gpu_number ${GPU_NUMBER} \
##  &> test_on_corrupted_text_full_finetuning_${METHOD}_${SEVERITY}_t5.out
