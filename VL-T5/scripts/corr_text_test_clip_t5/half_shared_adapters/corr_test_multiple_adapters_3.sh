...
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+19)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+20)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+21)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+22)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
...
METHOD=back_trans
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+23)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/multiple_adapters.sh $((PORT+24)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_adapters_${METHOD}_${SEVERITY}_t5.out
