...
PORT=$3
GPU_NUMBER=$1
#bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT)) \
#  --text_corruption_method none \
#  --text_corruption_severity 1 \
#  --gpu_number ${GPU_NUMBER} \
#  &> test_on_corrupted_text_single_lora_none_1_t5.out

# try out
#bash original_scripts/image_clip_t5_corr_test/single_lora.sh 26787 \
