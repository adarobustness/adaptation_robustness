...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+19)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+20)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+21)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+22)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+23)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
METHOD=back_trans
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+24)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
...
bash original_scripts/image_clip_t5_corr_test/single_lora.sh $((PORT+25)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_lora_${METHOD}_${SEVERITY}_t5.out
