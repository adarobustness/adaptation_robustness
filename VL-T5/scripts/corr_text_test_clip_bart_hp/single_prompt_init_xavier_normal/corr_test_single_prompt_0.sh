...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_init_xavier_normal.sh $((PORT)) \
  ...
  &> test_on_corrupted_text_single_prompt_init_xavier_normal_none_5.out

# try out
bash original_scripts/image_clip_bart_corr_hp/single_prompt_init_xavier_normal.sh 26787 \
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_init_xavier_normal.sh $((PORT+9)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_init_xavier_normal_${METHOD}_${SEVERITY}.out
