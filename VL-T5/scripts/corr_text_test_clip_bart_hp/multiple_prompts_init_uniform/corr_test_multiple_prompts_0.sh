...
bash original_scripts/image_clip_bart_corr_hp/multiple_prompts_init_uniform.sh $((PORT)) \
  ...
  &> test_on_corrupted_text_multiple_prompts_init_uniform_none_5.out

# try out
#bash original_scripts/image_clip_bart_corr_hp/multiple_prompts_init_uniform.sh 26787 \
...
bash original_scripts/image_clip_bart_corr_hp/multiple_prompts_init_uniform.sh $((PORT+9)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_prompts_init_uniform_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/multiple_prompts_init_uniform.sh $((PORT+8)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_multiple_prompts_init_uniform_${METHOD}_${SEVERITY}.out
