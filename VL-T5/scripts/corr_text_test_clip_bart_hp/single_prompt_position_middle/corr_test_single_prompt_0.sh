...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT)) \
  ...
  &> test_on_corrupted_text_single_prompt_position_middle_none_5.out

# try out
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh 26787 \
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT+1)) \
  ...
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_position_middle_${METHOD}_${SEVERITY}.out
#
#METHOD=swap_prefix
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT+6)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_position_middle_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT+7)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_position_middle_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT+9)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_position_middle_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/single_prompt_position_middle.sh $((PORT+8)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_prompt_position_middle_${METHOD}_${SEVERITY}.out
