...
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT)) \
  ...
  &> test_on_corrupted_text_half_shared_adapters_share_down_sampler_none_5.out

# try out
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh 26787 \
...
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+6)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+7)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+9)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_hp/half_shared_adapters_share_down_sampler.sh $((PORT+8)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_share_down_sampler_${METHOD}_${SEVERITY}.out
