...
## try out
#bash original_scripts/image_clip_t5_corr_hp/single_compacter_reduction_factor_32.sh 26787 \
...
bash original_scripts/image_clip_t5_corr_hp/single_compacter_reduction_factor_32.sh $((PORT+6)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_compacter_reduction_factor_32_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_t5_corr_hp/single_compacter_reduction_factor_32.sh $((PORT+7)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_compacter_reduction_factor_32_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_t5_corr_hp/single_compacter_reduction_factor_32.sh $((PORT+9)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_compacter_reduction_factor_32_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_t5_corr_hp/single_compacter_reduction_factor_32.sh $((PORT+8)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_single_compacter_reduction_factor_32_${METHOD}_${SEVERITY}.out
