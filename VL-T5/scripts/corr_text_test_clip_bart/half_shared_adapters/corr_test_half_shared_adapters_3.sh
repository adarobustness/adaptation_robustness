...
GPU_NUMBER=$1
METHOD=drop_first
bash original_scripts/image_clip_bart_corr_test/half_shared_adapters.sh $((PORT+16)) \
...
METHOD=drop_last
bash original_scripts/image_clip_bart_corr_test/half_shared_adapters.sh $((PORT+17)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_test/half_shared_adapters.sh $((PORT+18)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_${METHOD}_${SEVERITY}.out
...
bash original_scripts/image_clip_bart_corr_test/half_shared_adapters.sh $((PORT+19)) \
  --text_corruption_method ${METHOD} \
  --text_corruption_severity ${SEVERITY} \
  --gpu_number ${GPU_NUMBER} \
  &> test_on_corrupted_text_half_shared_adapters_${METHOD}_${SEVERITY}.out
