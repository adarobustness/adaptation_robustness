...
lr=1e-3
RATIO=$9
name=corr_test_4tasks_multiple_adapters_subset_ratio_${RATIO}_${CORRUPTION_METHOD}_${SEVERITY}
output=snap/${folder_prefix}_${task}/$name
LOAD_MODEL_FROM="./snap/VLT5_multitask/multiple_adapters_adapt_ratio_${RATIO}/LAST"
