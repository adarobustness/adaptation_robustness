...
RATIO=$9
lr=1e-4
name=corr_test_4tasks_full_finetuning_subset_ratio_${RATIO}_${CORRUPTION_METHOD}_${SEVERITY}
output=snap/${folder_prefix}_${task}/$name
LOAD_MODEL_FROM="./snap/VLT5_multitask/full_finetuning_adapt_ratio_${RATIO}/LAST"
