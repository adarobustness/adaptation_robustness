...
SEVERITY=$5
RATIO=$9
name=corr_test_4tasks_multiple_compacters_subset_ratio_${RATIO}_${CORRUPTION_METHOD}_${SEVERITY}
LOAD_MODEL_FROM="./snap/VLBart_multitask/multiple_compacters_adapt_ratio_${RATIO}/LAST"
