...
SEVERITY=$5
RATIO=$9
LOAD_MODEL_FROM="./snap/VLBart_multitask/single_lora_adapt_ratio_${RATIO}/LAST"
lr=1e-3

lora_dim=128

name=corr_test_4tasks_single_lora_subset_ratio_${RATIO}_${CORRUPTION_METHOD}_${SEVERITY}
