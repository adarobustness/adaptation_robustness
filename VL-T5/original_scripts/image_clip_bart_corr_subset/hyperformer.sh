...
SEVERITY=$5
RATIO=$9
LOAD_MODEL_FROM="./snap/VLBart_multitask/hyperformer_adapt_ratio_${RATIO}/LAST"
name=corr_test_4tasks_hyperformer_subset_ratio_${RATIO}_${CORRUPTION_METHOD}_${SEVERITY}
