...
lr=1e-3
RATIO=$9
name=corr_test_4tasks_single_adapter_reduction_factor_32_${CORRUPTION_METHOD}_${SEVERITY}
output=snap/${folder_prefix}_${task}/$name
LOAD_MODEL_FROM="./snap/VLBart_multitask/single_adapter_hp_reduction_factor_32/LAST"
