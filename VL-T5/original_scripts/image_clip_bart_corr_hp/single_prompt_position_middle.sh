...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/single_prompt_hp_position_middle/LAST"
lr=1e-3
name=corr_test_4tasks_single_prompt_position_middle_${CORRUPTION_METHOD}_${SEVERITY}
