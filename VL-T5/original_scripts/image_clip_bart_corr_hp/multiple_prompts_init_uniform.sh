...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/multiple_prompts_hp_init_uniform/LAST"
lr=1e-3
name=corr_test_4tasks_multiple_prompts_init_uniform_${CORRUPTION_METHOD}_${SEVERITY}
...
CUDA_VISIBLE_DEVICES=$7 python -m torch.distributed.launch \
    ...
    --to_test True \
    --to_train False \
    --encoder_prompt_init_method uniform
