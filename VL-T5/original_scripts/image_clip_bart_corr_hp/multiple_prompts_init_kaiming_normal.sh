...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/multiple_prompts_hp_init_kaiming_normal/LAST"
lr=1e-3
name=corr_test_4tasks_multiple_prompts_init_kaiming_normal_${CORRUPTION_METHOD}_${SEVERITY}
