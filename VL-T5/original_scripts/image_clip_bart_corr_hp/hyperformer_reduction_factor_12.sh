...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/hyperformer_hp_reduction_factor_12/LAST"
name=corr_test_4tasks_hyperformer_reduction_factor_12_${CORRUPTION_METHOD}_${SEVERITY}
