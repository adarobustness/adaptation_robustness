...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/single_compacter_hp_4/LAST"
name=corr_test_4tasks_single_compacter_reduction_factor_4_${CORRUPTION_METHOD}_${SEVERITY}
