...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/half_shared_adapters_hp_share_down_sampler/LAST"
name=corr_test_4tasks_half_shared_adapters_share_down_sampler_${CORRUPTION_METHOD}_${SEVERITY}
...
# I change the shared samplers from up to down.