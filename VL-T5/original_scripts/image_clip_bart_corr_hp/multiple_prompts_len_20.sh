...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/multiple_prompts_hp_len_20/LAST"
lr=1e-3
name=corr_test_4tasks_multiple_prompts_len_20_${CORRUPTION_METHOD}_${SEVERITY}
