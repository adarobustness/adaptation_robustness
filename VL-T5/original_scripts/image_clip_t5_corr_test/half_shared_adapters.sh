...
CORRUPTION_METHOD=$3
SEVERITY=$5
name=corr_test_4tasks_half_shared_adapters_${CORRUPTION_METHOD}_${SEVERITY}

output=snap/${folder_prefix}_${task}/$name
LOAD_MODEL_FROM="./snap/VLT5_multitask/reproduce_1gpu_4tasks_half_shared_adapters/LAST"
