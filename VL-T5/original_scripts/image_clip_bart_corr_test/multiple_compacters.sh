...
lr=1e-3
LOAD_MODEL_FROM="./snap/VLBart_multitask/reproduce_1gpu_4tasks_multiple_compacters/LAST"
hypercomplex_division=2
CORRUPTION_METHOD=$3
SEVERITY=$5
name=corr_test_4tasks_multiple_compacters_${CORRUPTION_METHOD}_${SEVERITY}
