...
CORRUPTION_METHOD=$3
SEVERITY=$5
LOAD_MODEL_FROM="./snap/VLBart_multitask/reproduce_1gpu_4tasks_single_prompt_rerun_for_caption/LAST"
lr=1e-3
name=corr_test_4tasks_single_prompt_${CORRUPTION_METHOD}_${SEVERITY}
