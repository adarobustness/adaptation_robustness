...
CORRUPTION_METHOD=$3
SEVERITY=$5
#LOAD_MODEL_FROM="./snap/VLBart_multitask/reproduce_1gpu_4tasks_multiple_lora/LAST"\
LOAD_MODEL_FROM="./snap/VLBart_multitask/reproduce_1gpu_4tasks_multiple_lora_2nd_times_for_nlvr/LAST"
name=corr_test_4tasks_multiple_lora_${CORRUPTION_METHOD}_${SEVERITY}
