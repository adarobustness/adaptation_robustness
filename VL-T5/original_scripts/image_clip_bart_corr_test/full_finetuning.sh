...
SEVERITY=$5
lr=1e-4
name=corr_test_4tasks_full_fituning_${CORRUPTION_METHOD}_${SEVERITY}
output=snap/${folder_prefix}_${task}/$name

LOAD_MODEL_FROM=${BASE_DIR}"./snap/VLBart_multitask/reproduce_1gpu_4tasks_full_finetuning/LAST"
